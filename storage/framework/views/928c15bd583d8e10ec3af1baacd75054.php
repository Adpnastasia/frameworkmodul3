                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        ...
                        <div class="dropdown" data-bs-theme="light">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><button class="dropdown-item" type="button"><small><i class="bi-circle-half-fill me-2"></i>Auto</small></button></li>
                            </ul>
                        </div>
                        </li>
                    </ul>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-md-7 order-md-1">
                    ...
                    <p class="fs-5 mt-3">Quickly design and costomize responsif ....... </p>
                    <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">Take Bootstrap to the next level with premium themes from the
                        <a href="#"> official Bootstrap Themes Marketplace</a>. Themes are built on Bootstrap as their
                        own extended frameworks, rich with new components and plugins, documentation, and powerful build tools.</p>
                        <a class="icon-link icon-link-hover lead fw-semibold mb-5"
                        href="#">
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img src="<?php echo e(Vite::asset('resources/images/logo-black.svg')); ?>" alt="" class="img-fluid" style="width: 40px;">
                            <div class="fs-5 ms-2 text-black">Bootstrap</div>
                        </div>
                    </a>
                    <div class="mt-2 text-muted">
                        <small>Designed and built with all the love in world by the <a href="">Bootstrap Team</a>with the help of <a href="" class="text-black">our contributors</a></small>
                    </div>
                    <div class="mt-2 text-muted">
...
<?php /**PATH C:\Users\ASUS\cloning\resources\views/bootstrap.blade.php ENDPATH**/ ?>